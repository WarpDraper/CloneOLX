...
// Imported once for its side effect from main.tsx. DEV-gated like every other console.log
// in this app (see createBaseQuery.ts) so production consoles stay quiet.
